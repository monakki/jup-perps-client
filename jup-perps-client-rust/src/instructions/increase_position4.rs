...
impl IncreasePosition4 {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&IncreasePosition4InstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct IncreasePosition4InstructionData {
            discriminator: [u8; 8],
      }

impl IncreasePosition4InstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [67, 147, 53, 23, 43, 57, 16, 67],
                  }
  }
}

impl Default for IncreasePosition4InstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `IncreasePosition4`.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
...
pub struct IncreasePosition4Builder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = IncreasePosition4 {
  ...
  /// `increase_position4` CPI accounts.
  pub struct IncreasePosition4CpiAccounts<'a, 'b> {
...
/// `increase_position4` CPI instruction.
pub struct IncreasePosition4Cpi<'a, 'b> {
...
impl<'a, 'b> IncreasePosition4Cpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: IncreasePosition4CpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `IncreasePosition4` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
          ...
          ///   15. `[]` program
#[derive(Clone, Debug)]
pub struct IncreasePosition4CpiBuilder<'a, 'b> {
  instruction: Box<IncreasePosition4CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IncreasePosition4CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(IncreasePosition4CpiBuilderInstruction {
      __program: program,
              keeper: None,
              perpetuals: None,
              pool: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = IncreasePosition4Cpi {
...
#[derive(Clone, Debug)]
struct IncreasePosition4CpiBuilderInstruction<'a, 'b> {
