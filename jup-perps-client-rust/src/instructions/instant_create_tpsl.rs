...
impl InstantCreateTpsl {
  pub fn instruction(&self, args: InstantCreateTpslInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InstantCreateTpslInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InstantCreateTpslInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InstantCreateTpslInstructionData {
            discriminator: [u8; 8],
                                                }

impl InstantCreateTpslInstructionData {
  pub fn new() -> Self {
    Self {
...
impl Default for InstantCreateTpslInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InstantCreateTpslInstructionArgs {
...
/// Instruction builder for `InstantCreateTpsl`.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
...
pub struct InstantCreateTpslBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InstantCreateTpsl {
          ...
          let args = InstantCreateTpslInstructionArgs {
                                                              collateral_usd_delta: self.collateral_usd_delta.clone().expect("collateral_usd_delta is not set"),
                                                                  ...
                                                                  trigger_above_threshold: self.trigger_above_threshold.clone().expect("trigger_above_threshold is not set"),
                                                                  entire_position: self.entire_position.clone().expect("entire_position is not set"),
  ...
  /// `instant_create_tpsl` CPI accounts.
  pub struct InstantCreateTpslCpiAccounts<'a, 'b> {
...
/// `instant_create_tpsl` CPI instruction.
pub struct InstantCreateTpslCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: InstantCreateTpslInstructionArgs,
  }

impl<'a, 'b> InstantCreateTpslCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: InstantCreateTpslCpiAccounts<'a, 'b>,
...
/// Instruction builder for `InstantCreateTpsl` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
          ...
          ///   19. `[]` program
#[derive(Clone, Debug)]
pub struct InstantCreateTpslCpiBuilder<'a, 'b> {
  instruction: Box<InstantCreateTpslCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InstantCreateTpslCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InstantCreateTpslCpiBuilderInstruction {
      __program: program,
              keeper: None,
              api_keeper: None,
              owner: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InstantCreateTpslInstructionArgs {
                                                              collateral_usd_delta: self.instruction.collateral_usd_delta.clone().expect("collateral_usd_delta is not set"),
                                                                  ...
                                                                  trigger_above_threshold: self.instruction.trigger_above_threshold.clone().expect("trigger_above_threshold is not set"),
                                                                  entire_position: self.instruction.entire_position.clone().expect("entire_position is not set"),
                                                                  counter: self.instruction.counter.clone().expect("counter is not set"),
                                                                  request_time: self.instruction.request_time.clone().expect("request_time is not set"),
                                    };
        let instruction = InstantCreateTpslCpi {
...
#[derive(Clone, Debug)]
struct InstantCreateTpslCpiBuilderInstruction<'a, 'b> {
