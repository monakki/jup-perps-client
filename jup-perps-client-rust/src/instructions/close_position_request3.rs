...
pub const CLOSE_POSITION_REQUEST3_DISCRIMINATOR: [u8; 8] = [122, 130, 33, 18, 211, 44, 161, 58];
...
impl ClosePositionRequest3 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(keeper) = self.keeper {
            accounts.push(solana_program::instruction::AccountMeta::new(keeper, true));
        } else {
        ...
        let data = borsh::to_vec(&ClosePositionRequest3InstructionData::new()).unwrap();
...
pub struct ClosePositionRequest3InstructionData {
    discriminator: [u8; 8],
}

impl ClosePositionRequest3InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [122, 130, 33, 18, 211, 44, 161, 58],
        }
    }
}

impl Default for ClosePositionRequest3InstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ClosePositionRequest3`.
///
/// ### Accounts:
///
...
pub struct ClosePositionRequest3Builder {
...
impl ClosePositionRequest3Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// `[optional account]`
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ClosePositionRequest3 {
            keeper: self.keeper,
...
/// `close_position_request3` CPI accounts.
pub struct ClosePositionRequest3CpiAccounts<'a, 'b> {
...
/// `close_position_request3` CPI instruction.
pub struct ClosePositionRequest3Cpi<'a, 'b> {
...
impl<'a, 'b> ClosePositionRequest3Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ClosePositionRequest3CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClosePositionRequest3` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer, optional]` keeper
...
///   13. `[]` program
#[derive(Clone, Debug)]
pub struct ClosePositionRequest3CpiBuilder<'a, 'b> {
    instruction: Box<ClosePositionRequest3CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClosePositionRequest3CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClosePositionRequest3CpiBuilderInstruction {
            __program: program,
            keeper: None,
            owner: None,
            owner_ata: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ClosePositionRequest3Cpi {
...
#[derive(Clone, Debug)]
struct ClosePositionRequest3CpiBuilderInstruction<'a, 'b> {
