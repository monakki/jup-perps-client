...
impl InstantUpdateLimitOrder {
  pub fn instruction(&self, args: InstantUpdateLimitOrderInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InstantUpdateLimitOrderInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InstantUpdateLimitOrderInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InstantUpdateLimitOrderInstructionData {
            discriminator: [u8; 8],
                        }

impl InstantUpdateLimitOrderInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [136, 245, 229, 58, 121, 141, 12, 207],
                                                            }
  }
}

impl Default for InstantUpdateLimitOrderInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InstantUpdateLimitOrderInstructionArgs {
...
/// Instruction builder for `InstantUpdateLimitOrder`.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
...
pub struct InstantUpdateLimitOrderBuilder {
...
impl InstantUpdateLimitOrderBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InstantUpdateLimitOrder {
          ...
          let args = InstantUpdateLimitOrderInstructionArgs {
  ...
  /// `instant_update_limit_order` CPI accounts.
  pub struct InstantUpdateLimitOrderCpiAccounts<'a, 'b> {
...
/// `instant_update_limit_order` CPI instruction.
pub struct InstantUpdateLimitOrderCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: InstantUpdateLimitOrderInstructionArgs,
  }

impl<'a, 'b> InstantUpdateLimitOrderCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: InstantUpdateLimitOrderCpiAccounts<'a, 'b>,
...
/// Instruction builder for `InstantUpdateLimitOrder` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
          ...
          ///   9. `[]` custody_pythnet_price_account
#[derive(Clone, Debug)]
pub struct InstantUpdateLimitOrderCpiBuilder<'a, 'b> {
  instruction: Box<InstantUpdateLimitOrderCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InstantUpdateLimitOrderCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InstantUpdateLimitOrderCpiBuilderInstruction {
      __program: program,
              keeper: None,
              api_keeper: None,
              owner: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = InstantUpdateLimitOrderCpi {
...
#[derive(Clone, Debug)]
struct InstantUpdateLimitOrderCpiBuilderInstruction<'a, 'b> {
