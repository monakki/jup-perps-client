...
impl<'a, 'b> CreateTokenLedgerCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn token_ledger(&mut self, token_ledger: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          token_ledger: self.instruction.token_ledger.expect("token_ledger is not set"),
