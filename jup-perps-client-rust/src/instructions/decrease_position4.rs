...
impl DecreasePosition4 {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&DecreasePosition4InstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DecreasePosition4InstructionData {
            discriminator: [u8; 8],
      }

impl DecreasePosition4InstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [185, 161, 114, 175, 96, 148, 3, 170],
                  }
  }
}

impl Default for DecreasePosition4InstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `DecreasePosition4`.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
...
pub struct DecreasePosition4Builder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = DecreasePosition4 {
  ...
  /// `decrease_position4` CPI accounts.
  pub struct DecreasePosition4CpiAccounts<'a, 'b> {
...
/// `decrease_position4` CPI instruction.
pub struct DecreasePosition4Cpi<'a, 'b> {
...
impl<'a, 'b> DecreasePosition4Cpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: DecreasePosition4CpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `DecreasePosition4` via CPI.
///
/// ### Accounts:
///
                ///   0. `[signer]` keeper
          ...
          ///   17. `[]` program
#[derive(Clone, Debug)]
pub struct DecreasePosition4CpiBuilder<'a, 'b> {
  instruction: Box<DecreasePosition4CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DecreasePosition4CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DecreasePosition4CpiBuilderInstruction {
      __program: program,
              keeper: None,
              owner: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = DecreasePosition4Cpi {
...
#[derive(Clone, Debug)]
struct DecreasePosition4CpiBuilderInstruction<'a, 'b> {
