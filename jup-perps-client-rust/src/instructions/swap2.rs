...
impl Swap2 {
  pub fn instruction(&self, args: Swap2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: Swap2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl Swap2Builder {
  pub fn new() -> Self {
    ...
    pub fn receiving_custody(&mut self, receiving_custody: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn receiving_custody_doves_price_account(&mut self, receiving_custody_doves_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.receiving_custody_doves_price_account = Some(receiving_custody_doves_price_account);
                    self
    }
            #[inline(always)]
    pub fn receiving_custody_pythnet_price_account(&mut self, receiving_custody_pythnet_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.receiving_custody_pythnet_price_account = Some(receiving_custody_pythnet_price_account);
                    self
    }
            #[inline(always)]
    pub fn receiving_custody_token_account(&mut self, receiving_custody_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn dispensing_custody(&mut self, dispensing_custody: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn dispensing_custody_doves_price_account(&mut self, dispensing_custody_doves_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.dispensing_custody_doves_price_account = Some(dispensing_custody_doves_price_account);
                    self
    }
            #[inline(always)]
    pub fn dispensing_custody_pythnet_price_account(&mut self, dispensing_custody_pythnet_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.dispensing_custody_pythnet_price_account = Some(dispensing_custody_pythnet_price_account);
                    self
    }
            #[inline(always)]
    pub fn dispensing_custody_token_account(&mut self, dispensing_custody_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    let accounts = Swap2 {
          ...
          let args = Swap2InstructionArgs {
                                                              amount_in: self.amount_in.clone().expect("amount_in is not set"),
                                                                  min_amount_out: self.min_amount_out.clone().expect("min_amount_out is not set"),
                                    };
...
impl<'a, 'b> Swap2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn receiving_custody(&mut self, receiving_custody: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn receiving_custody_doves_price_account(&mut self, receiving_custody_doves_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.receiving_custody_doves_price_account = Some(receiving_custody_doves_price_account);
                    self
    }
      #[inline(always)]
    pub fn receiving_custody_pythnet_price_account(&mut self, receiving_custody_pythnet_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.receiving_custody_pythnet_price_account = Some(receiving_custody_pythnet_price_account);
                    self
    }
      #[inline(always)]
    pub fn receiving_custody_token_account(&mut self, receiving_custody_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn dispensing_custody(&mut self, dispensing_custody: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dispensing_custody_doves_price_account(&mut self, dispensing_custody_doves_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.dispensing_custody_doves_price_account = Some(dispensing_custody_doves_price_account);
                    self
    }
      #[inline(always)]
    pub fn dispensing_custody_pythnet_price_account(&mut self, dispensing_custody_pythnet_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.dispensing_custody_pythnet_price_account = Some(dispensing_custody_pythnet_price_account);
                    self
    }
      #[inline(always)]
    pub fn dispensing_custody_token_account(&mut self, dispensing_custody_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = Swap2InstructionArgs {
                                                              amount_in: self.instruction.amount_in.clone().expect("amount_in is not set"),
                                                                  min_amount_out: self.instruction.min_amount_out.clone().expect("min_amount_out is not set"),
                                    };
...
struct Swap2CpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            owner: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                receiving_custody_doves_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                receiving_custody_pythnet_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                dispensing_custody_doves_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                dispensing_custody_pythnet_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
