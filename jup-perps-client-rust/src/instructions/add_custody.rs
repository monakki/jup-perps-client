...
impl AddCustody {
  pub fn instruction(&self, args: AddCustodyInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddCustodyInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl AddCustodyBuilder {
  pub fn new() -> Self {
    ...
    pub fn custody_token_account(&mut self, custody_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn custody_token_mint(&mut self, custody_token_mint: solana_program::pubkey::Pubkey) -> &mut Self {
...
impl<'a, 'b> AddCustodyCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn custody_token_account(&mut self, custody_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn custody_token_mint(&mut self, custody_token_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = AddCustodyInstructionArgs {
                                                              is_stable: self.instruction.is_stable.clone().expect("is_stable is not set"),
