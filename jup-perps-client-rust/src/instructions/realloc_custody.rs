...
pub const REALLOC_CUSTODY_DISCRIMINATOR: [u8; 8] = [123, 58, 109, 139, 133, 7, 225, 200];
...
impl ReallocCustody {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&ReallocCustodyInstructionData::new()).unwrap();
...
pub struct ReallocCustodyInstructionData {
    discriminator: [u8; 8],
}

impl ReallocCustodyInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [123, 58, 109, 139, 133, 7, 225, 200],
        }
    }
}

impl Default for ReallocCustodyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `ReallocCustody`.
///
/// ### Accounts:
///
...
pub struct ReallocCustodyBuilder {
...
/// `realloc_custody` CPI accounts.
pub struct ReallocCustodyCpiAccounts<'a, 'b> {
...
/// `realloc_custody` CPI instruction.
pub struct ReallocCustodyCpi<'a, 'b> {
...
impl<'a, 'b> ReallocCustodyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ReallocCustodyCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ReallocCustody` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` keeper
...
///   3. `[]` rent
#[derive(Clone, Debug)]
pub struct ReallocCustodyCpiBuilder<'a, 'b> {
    instruction: Box<ReallocCustodyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ReallocCustodyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ReallocCustodyCpiBuilderInstruction {
            __program: program,
            keeper: None,
            custody: None,
            system_program: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ReallocCustodyCpi {
...
#[derive(Clone, Debug)]
struct ReallocCustodyCpiBuilderInstruction<'a, 'b> {
