...
impl AddLiquidity2 {
  pub fn instruction(&self, args: AddLiquidity2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidity2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = AddLiquidity2 {
          ...
          let args = AddLiquidity2InstructionArgs {
                                                              token_amount_in: self.token_amount_in.clone().expect("token_amount_in is not set"),
                                                                  min_lp_amount_out: self.min_lp_amount_out.clone().expect("min_lp_amount_out is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = AddLiquidity2InstructionArgs {
                                                              token_amount_in: self.instruction.token_amount_in.clone().expect("token_amount_in is not set"),
                                                                  min_lp_amount_out: self.instruction.min_lp_amount_out.clone().expect("min_lp_amount_out is not set"),
