...
impl GetRemoveLiquidityAmountAndFee2 {
  pub fn instruction(&self, args: GetRemoveLiquidityAmountAndFee2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: GetRemoveLiquidityAmountAndFee2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl GetRemoveLiquidityAmountAndFee2Builder {
  pub fn new() -> Self {
    ...
    pub fn lp_token_mint(&mut self, lp_token_mint: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn lp_amount_in(&mut self, lp_amount_in: u64) -> &mut Self {
        self.lp_amount_in = Some(lp_amount_in);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = GetRemoveLiquidityAmountAndFee2 {
          ...
          let args = GetRemoveLiquidityAmountAndFee2InstructionArgs {
                                                              lp_amount_in: self.lp_amount_in.clone().expect("lp_amount_in is not set"),
                                    };
...
impl<'a, 'b> GetRemoveLiquidityAmountAndFee2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn lp_token_mint(&mut self, lp_token_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn lp_amount_in(&mut self, lp_amount_in: u64) -> &mut Self {
        self.instruction.lp_amount_in = Some(lp_amount_in);
        self
      }
        /// Add an additional account to the instruction.
  #[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = GetRemoveLiquidityAmountAndFee2InstructionArgs {
                                                              lp_amount_in: self.instruction.lp_amount_in.clone().expect("lp_amount_in is not set"),
                                    };
