...
pub const GET_REMOVE_LIQUIDITY_AMOUNT_AND_FEE2_DISCRIMINATOR: [u8; 8] =
...
impl GetRemoveLiquidityAmountAndFee2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&GetRemoveLiquidityAmountAndFee2InstructionData::new()).unwrap();
    ...
    pub fn invoke_signed(
        ...
        let args = GetRemoveLiquidityAmountAndFee2InstructionArgs {
            lp_amount_in: self
                ...
                .lp_amount_in
                .clone()
                .expect("lp_amount_in is not set"),
        };
