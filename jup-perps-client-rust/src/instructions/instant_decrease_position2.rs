...
pub const INSTANT_DECREASE_POSITION2_DISCRIMINATOR: [u8; 8] = [162, 191, 200, 62, 139, 62, 176, 17];
...
impl InstantDecreasePosition2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&InstantDecreasePosition2InstructionData::new()).unwrap();
...
pub struct InstantDecreasePosition2InstructionData {
    discriminator: [u8; 8],
}

impl InstantDecreasePosition2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [162, 191, 200, 62, 139, 62, 176, 17],
        }
    }
}

impl Default for InstantDecreasePosition2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InstantDecreasePosition2InstructionArgs {
...
/// Instruction builder for `InstantDecreasePosition2`.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   15. `[writable]` position_request
///   16. `[writable]` position_request_ata
...
pub struct InstantDecreasePosition2Builder {
...
impl InstantDecreasePosition2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InstantDecreasePosition2 {
        ...
        let args = InstantDecreasePosition2InstructionArgs {
...
/// `instant_decrease_position2` CPI accounts.
pub struct InstantDecreasePosition2CpiAccounts<'a, 'b> {
...
/// `instant_decrease_position2` CPI instruction.
pub struct InstantDecreasePosition2Cpi<'a, 'b> {
    ...
    pub __args: InstantDecreasePosition2InstructionArgs,
}

impl<'a, 'b> InstantDecreasePosition2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InstantDecreasePosition2CpiAccounts<'a, 'b>,
        args: InstantDecreasePosition2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InstantDecreasePosition2` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   21. `[]` program
#[derive(Clone, Debug)]
pub struct InstantDecreasePosition2CpiBuilder<'a, 'b> {
    instruction: Box<InstantDecreasePosition2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InstantDecreasePosition2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InstantDecreasePosition2CpiBuilderInstruction {
            __program: program,
            keeper: None,
            api_keeper: None,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InstantDecreasePosition2Cpi {
...
#[derive(Clone, Debug)]
struct InstantDecreasePosition2CpiBuilderInstruction<'a, 'b> {
