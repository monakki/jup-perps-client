...
impl CreateDecreasePositionRequest2 {
  pub fn instruction(&self, args: CreateDecreasePositionRequest2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateDecreasePositionRequest2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CreateDecreasePositionRequest2InstructionData::new()).unwrap();
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CreateDecreasePositionRequest2InstructionArgs {
                                                              collateral_usd_delta: self.instruction.collateral_usd_delta.clone().expect("collateral_usd_delta is not set"),
                                                                  ...
                                                                  request_type: self.instruction.request_type.clone().expect("request_type is not set"),
