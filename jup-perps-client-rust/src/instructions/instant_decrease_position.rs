...
impl InstantDecreasePosition {
  pub fn instruction(&self, args: InstantDecreasePositionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InstantDecreasePositionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl InstantDecreasePositionBuilder {
  pub fn new() -> Self {
    ...
    pub fn collateral_custody(&mut self, collateral_custody: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn collateral_custody_doves_price_account(&mut self, collateral_custody_doves_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.collateral_custody_doves_price_account = Some(collateral_custody_doves_price_account);
                    self
    }
            #[inline(always)]
    pub fn collateral_custody_pythnet_price_account(&mut self, collateral_custody_pythnet_price_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.collateral_custody_pythnet_price_account = Some(collateral_custody_pythnet_price_account);
                    self
    }
            #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = InstantDecreasePosition {
                              keeper: self.keeper.expect("keeper is not set"),
                                        ...
                                        collateral_custody_pythnet_price_account: self.collateral_custody_pythnet_price_account.expect("collateral_custody_pythnet_price_account is not set"),
          ...
          let args = InstantDecreasePositionInstructionArgs {
                                                              collateral_usd_delta: self.collateral_usd_delta.clone().expect("collateral_usd_delta is not set"),
                                                                  size_usd_delta: self.size_usd_delta.clone().expect("size_usd_delta is not set"),
                                                                  price_slippage: self.price_slippage.clone().expect("price_slippage is not set"),
  ...
  pub fn new(
    ...
    Self {
      __program: program,
              ...
              collateral_custody_pythnet_price_account: accounts.collateral_custody_pythnet_price_account,
...
impl<'a, 'b> InstantDecreasePositionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn keeper(&mut self, keeper: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn api_keeper(&mut self, api_keeper: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn collateral_custody(&mut self, collateral_custody: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn collateral_custody_doves_price_account(&mut self, collateral_custody_doves_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.collateral_custody_doves_price_account = Some(collateral_custody_doves_price_account);
                    self
    }
      #[inline(always)]
    pub fn collateral_custody_pythnet_price_account(&mut self, collateral_custody_pythnet_price_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.collateral_custody_pythnet_price_account = Some(collateral_custody_pythnet_price_account);
                    self
    }
      #[inline(always)]
    pub fn collateral_custody_token_account(&mut self, collateral_custody_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn desired_mint(&mut self, desired_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InstantDecreasePositionInstructionArgs {
                                                              collateral_usd_delta: self.instruction.collateral_usd_delta.clone().expect("collateral_usd_delta is not set"),
                                                                  size_usd_delta: self.instruction.size_usd_delta.clone().expect("size_usd_delta is not set"),
                                                                  price_slippage: self.instruction.price_slippage.clone().expect("price_slippage is not set"),
                                                                  entire_position: self.instruction.entire_position.clone(),
                                                                  request_time: self.instruction.request_time.clone().expect("request_time is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          collateral_custody_pythnet_price_account: self.instruction.collateral_custody_pythnet_price_account.expect("collateral_custody_pythnet_price_account is not set"),
          ...
          desired_mint: self.instruction.desired_mint.expect("desired_mint is not set"),
...
struct InstantDecreasePositionCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            keeper: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                collateral_custody_doves_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                collateral_custody_pythnet_price_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
