...
impl Init {
  pub fn instruction(&self, args: InitInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl InitBuilder {
  pub fn new() -> Self {
    Self::default()
            ...
            #[inline(always)]
    pub fn upgrade_authority(&mut self, upgrade_authority: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    pub fn perpetuals(&mut self, perpetuals: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn perpetuals_program(&mut self, perpetuals_program: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.perpetuals_program = Some(perpetuals_program);
                    self
    }
            #[inline(always)]
    pub fn perpetuals_program_data(&mut self, perpetuals_program_data: solana_program::pubkey::Pubkey) -> &mut Self {
    ...
    let accounts = Init {
          ...
          let args = InitInstructionArgs {
                                                              allow_swap: self.allow_swap.clone().expect("allow_swap is not set"),
                                                                  allow_add_liquidity: self.allow_add_liquidity.clone().expect("allow_add_liquidity is not set"),
                                                                  allow_remove_liquidity: self.allow_remove_liquidity.clone().expect("allow_remove_liquidity is not set"),
                                                                  allow_increase_position: self.allow_increase_position.clone().expect("allow_increase_position is not set"),
                                                                  allow_decrease_position: self.allow_decrease_position.clone().expect("allow_decrease_position is not set"),
                                                                  allow_collateral_withdrawal: self.allow_collateral_withdrawal.clone().expect("allow_collateral_withdrawal is not set"),
                                                                  allow_liquidate_position: self.allow_liquidate_position.clone().expect("allow_liquidate_position is not set"),
                                    };
...
impl<'a, 'b> InitCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn upgrade_authority(&mut self, upgrade_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn perpetuals(&mut self, perpetuals: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn perpetuals_program(&mut self, perpetuals_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.perpetuals_program = Some(perpetuals_program);
                    self
    }
      #[inline(always)]
    pub fn perpetuals_program_data(&mut self, perpetuals_program_data: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitInstructionArgs {
                                                              allow_swap: self.instruction.allow_swap.clone().expect("allow_swap is not set"),
                                                                  allow_add_liquidity: self.instruction.allow_add_liquidity.clone().expect("allow_add_liquidity is not set"),
                                                                  allow_remove_liquidity: self.instruction.allow_remove_liquidity.clone().expect("allow_remove_liquidity is not set"),
                                                                  allow_increase_position: self.instruction.allow_increase_position.clone().expect("allow_increase_position is not set"),
                                                                  allow_decrease_position: self.instruction.allow_decrease_position.clone().expect("allow_decrease_position is not set"),
                                                                  allow_collateral_withdrawal: self.instruction.allow_collateral_withdrawal.clone().expect("allow_collateral_withdrawal is not set"),
                                                                  allow_liquidate_position: self.instruction.allow_liquidate_position.clone().expect("allow_liquidate_position is not set"),
                                    };
