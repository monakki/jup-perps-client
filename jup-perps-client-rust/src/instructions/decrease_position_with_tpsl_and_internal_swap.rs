...
pub const DECREASE_POSITION_WITH_TPSL_AND_INTERNAL_SWAP_DISCRIMINATOR: [u8; 8] =
...
impl DecreasePositionWithTpslAndInternalSwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data =
            borsh::to_vec(&DecreasePositionWithTpslAndInternalSwapInstructionData::new()).unwrap();
...
pub struct DecreasePositionWithTpslAndInternalSwapInstructionData {
    discriminator: [u8; 8],
}

impl DecreasePositionWithTpslAndInternalSwapInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [2, 111, 200, 231, 35, 65, 123, 235],
        }
    }
}

impl Default for DecreasePositionWithTpslAndInternalSwapInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `DecreasePositionWithTpslAndInternalSwap`.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   13. `[writable]` dispensing_custody
///   14. `[]` dispensing_custody_doves_price_account
///   15. `[writable]` dispensing_custody_token_account
///   16. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   17. `[]` event_authority
///   18. `[]` program
#[derive(Clone, Debug, Default)]
pub struct DecreasePositionWithTpslAndInternalSwapBuilder {
...
impl DecreasePositionWithTpslAndInternalSwapBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DecreasePositionWithTpslAndInternalSwap {
...
/// `decrease_position_with_tpsl_and_internal_swap` CPI accounts.
pub struct DecreasePositionWithTpslAndInternalSwapCpiAccounts<'a, 'b> {
...
/// `decrease_position_with_tpsl_and_internal_swap` CPI instruction.
pub struct DecreasePositionWithTpslAndInternalSwapCpi<'a, 'b> {
...
impl<'a, 'b> DecreasePositionWithTpslAndInternalSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DecreasePositionWithTpslAndInternalSwapCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DecreasePositionWithTpslAndInternalSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` keeper
...
///   18. `[]` program
#[derive(Clone, Debug)]
pub struct DecreasePositionWithTpslAndInternalSwapCpiBuilder<'a, 'b> {
    instruction: Box<DecreasePositionWithTpslAndInternalSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DecreasePositionWithTpslAndInternalSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(
            DecreasePositionWithTpslAndInternalSwapCpiBuilderInstruction {
                __program: program,
                keeper: None,
                owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DecreasePositionWithTpslAndInternalSwapCpi {
...
#[derive(Clone, Debug)]
struct DecreasePositionWithTpslAndInternalSwapCpiBuilderInstruction<'a, 'b> {
