...
impl DepositCollateralForBorrows {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&DepositCollateralForBorrowsInstructionData::new()).unwrap();
...
pub struct DepositCollateralForBorrowsInstructionData {
    discriminator: [u8; 8],
}

impl DepositCollateralForBorrowsInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [17, 2, 195, 190, 76, 16, 238, 74],
        }
    }
}

impl Default for DepositCollateralForBorrowsInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DepositCollateralForBorrowsInstructionArgs {
    pub amount: u64,
}

/// Instruction builder for `DepositCollateralForBorrows`.
///
/// ### Accounts:
///
...
pub struct DepositCollateralForBorrowsBuilder {
...
impl DepositCollateralForBorrowsBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DepositCollateralForBorrows {
        ...
        let args = DepositCollateralForBorrowsInstructionArgs {
...
/// `deposit_collateral_for_borrows` CPI accounts.
pub struct DepositCollateralForBorrowsCpiAccounts<'a, 'b> {
...
/// `deposit_collateral_for_borrows` CPI instruction.
pub struct DepositCollateralForBorrowsCpi<'a, 'b> {
    ...
    pub __args: DepositCollateralForBorrowsInstructionArgs,
}

impl<'a, 'b> DepositCollateralForBorrowsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DepositCollateralForBorrowsCpiAccounts<'a, 'b>,
        args: DepositCollateralForBorrowsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DepositCollateralForBorrows` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` owner
...
///   12. `[]` program
#[derive(Clone, Debug)]
pub struct DepositCollateralForBorrowsCpiBuilder<'a, 'b> {
    instruction: Box<DepositCollateralForBorrowsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositCollateralForBorrowsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DepositCollateralForBorrowsCpiBuilderInstruction {
            __program: program,
            owner: None,
            perpetuals: None,
            pool: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DepositCollateralForBorrowsCpi {
...
#[derive(Clone, Debug)]
struct DepositCollateralForBorrowsCpiBuilderInstruction<'a, 'b> {
