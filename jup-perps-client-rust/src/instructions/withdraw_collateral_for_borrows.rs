...
/// Accounts.
#[derive(Debug)]
pub struct WithdrawCollateralForBorrows {
...
impl WithdrawCollateralForBorrows {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&WithdrawCollateralForBorrowsInstructionData::new()).unwrap();
...
pub struct WithdrawCollateralForBorrowsInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawCollateralForBorrowsInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [117, 160, 60, 82, 237, 233, 46, 182],
        }
    }
}

impl Default for WithdrawCollateralForBorrowsInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct WithdrawCollateralForBorrowsInstructionArgs {
    pub amount: u64,
}

/// Instruction builder for `WithdrawCollateralForBorrows`.
///
/// ### Accounts:
///
...
pub struct WithdrawCollateralForBorrowsBuilder {
...
impl WithdrawCollateralForBorrowsBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = WithdrawCollateralForBorrows {
        ...
        let args = WithdrawCollateralForBorrowsInstructionArgs {
...
/// `withdraw_collateral_for_borrows` CPI accounts.
pub struct WithdrawCollateralForBorrowsCpiAccounts<'a, 'b> {
...
/// `withdraw_collateral_for_borrows` CPI instruction.
pub struct WithdrawCollateralForBorrowsCpi<'a, 'b> {
    ...
    pub __args: WithdrawCollateralForBorrowsInstructionArgs,
}

impl<'a, 'b> WithdrawCollateralForBorrowsCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawCollateralForBorrowsCpiAccounts<'a, 'b>,
        args: WithdrawCollateralForBorrowsInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawCollateralForBorrows` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` owner
...
///   11. `[]` program
#[derive(Clone, Debug)]
pub struct WithdrawCollateralForBorrowsCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawCollateralForBorrowsCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawCollateralForBorrowsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawCollateralForBorrowsCpiBuilderInstruction {
            __program: program,
            owner: None,
            perpetuals: None,
            pool: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawCollateralForBorrowsCpi {
...
#[derive(Clone, Debug)]
struct WithdrawCollateralForBorrowsCpiBuilderInstruction<'a, 'b> {
