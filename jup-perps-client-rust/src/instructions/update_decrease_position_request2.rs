...
impl UpdateDecreasePositionRequest2 {
  pub fn instruction(&self, args: UpdateDecreasePositionRequest2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: UpdateDecreasePositionRequest2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&UpdateDecreasePositionRequest2InstructionData::new()).unwrap();
