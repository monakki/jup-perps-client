...
pub const INSTANT_INCREASE_POSITION_PRE_SWAP_DISCRIMINATOR: [u8; 8] =
...
impl InstantIncreasePositionPreSwap {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data =
            borsh::to_vec(&InstantIncreasePositionPreSwapInstructionData::new()).unwrap();
...
pub struct InstantIncreasePositionPreSwapInstructionData {
    discriminator: [u8; 8],
}

impl InstantIncreasePositionPreSwapInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [197, 38, 86, 165, 199, 23, 38, 234],
        }
    }
}

impl Default for InstantIncreasePositionPreSwapInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InstantIncreasePositionPreSwapInstructionArgs {
    pub amount_in: u64,
    pub min_amount_out: u64,
}

/// Instruction builder for `InstantIncreasePositionPreSwap`.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
///   8. `[writable]` receiving_custody_token_account
///   9. `[writable]` dispensing_custody
///   10. `[]` dispensing_custody_doves_price_account
///   11. `[writable]` dispensing_custody_token_account
///   12. `[optional]` token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   13. `[]` instruction
///   14. `[]` event_authority
///   15. `[]` program
#[derive(Clone, Debug, Default)]
pub struct InstantIncreasePositionPreSwapBuilder {
...
impl InstantIncreasePositionPreSwapBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = InstantIncreasePositionPreSwap {
        ...
        let args = InstantIncreasePositionPreSwapInstructionArgs {
...
/// `instant_increase_position_pre_swap` CPI accounts.
pub struct InstantIncreasePositionPreSwapCpiAccounts<'a, 'b> {
...
/// `instant_increase_position_pre_swap` CPI instruction.
pub struct InstantIncreasePositionPreSwapCpi<'a, 'b> {
    ...
    pub __args: InstantIncreasePositionPreSwapInstructionArgs,
}

impl<'a, 'b> InstantIncreasePositionPreSwapCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: InstantIncreasePositionPreSwapCpiAccounts<'a, 'b>,
        args: InstantIncreasePositionPreSwapInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InstantIncreasePositionPreSwap` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct InstantIncreasePositionPreSwapCpiBuilder<'a, 'b> {
    instruction: Box<InstantIncreasePositionPreSwapCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InstantIncreasePositionPreSwapCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InstantIncreasePositionPreSwapCpiBuilderInstruction {
            __program: program,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = InstantIncreasePositionPreSwapCpi {
...
#[derive(Clone, Debug)]
struct InstantIncreasePositionPreSwapCpiBuilderInstruction<'a, 'b> {
