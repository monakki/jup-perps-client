...
pub const SWAP_WITH_TOKEN_LEDGER_DISCRIMINATOR: [u8; 8] = [139, 141, 238, 197, 41, 211, 172, 19];

/// Accounts.
#[derive(Debug)]
pub struct SwapWithTokenLedger {
...
impl SwapWithTokenLedger {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&SwapWithTokenLedgerInstructionData::new()).unwrap();
...
pub struct SwapWithTokenLedgerInstructionData {
    discriminator: [u8; 8],
}

impl SwapWithTokenLedgerInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [139, 141, 238, 197, 41, 211, 172, 19],
        }
    }
}

impl Default for SwapWithTokenLedgerInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapWithTokenLedgerInstructionArgs {
    pub min_amount_out: u64,
}

/// Instruction builder for `SwapWithTokenLedger`.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
pub struct SwapWithTokenLedgerBuilder {
...
impl SwapWithTokenLedgerBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SwapWithTokenLedger {
        ...
        let args = SwapWithTokenLedgerInstructionArgs {
            min_amount_out: self
                .min_amount_out
                .clone()
...
/// `swap_with_token_ledger` CPI accounts.
pub struct SwapWithTokenLedgerCpiAccounts<'a, 'b> {
...
/// `swap_with_token_ledger` CPI instruction.
pub struct SwapWithTokenLedgerCpi<'a, 'b> {
    ...
    pub __args: SwapWithTokenLedgerInstructionArgs,
}

impl<'a, 'b> SwapWithTokenLedgerCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SwapWithTokenLedgerCpiAccounts<'a, 'b>,
        args: SwapWithTokenLedgerInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapWithTokenLedger` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` owner
...
///   16. `[]` program
#[derive(Clone, Debug)]
pub struct SwapWithTokenLedgerCpiBuilder<'a, 'b> {
    instruction: Box<SwapWithTokenLedgerCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapWithTokenLedgerCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapWithTokenLedgerCpiBuilderInstruction {
            __program: program,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SwapWithTokenLedgerCpi {
...
#[derive(Clone, Debug)]
struct SwapWithTokenLedgerCpiBuilderInstruction<'a, 'b> {
