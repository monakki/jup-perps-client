...
impl CreateDecreasePositionMarketRequest {
  pub fn instruction(&self, args: CreateDecreasePositionMarketRequestInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateDecreasePositionMarketRequestInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CreateDecreasePositionMarketRequestInstructionData::new()).unwrap();
