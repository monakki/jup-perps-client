...
export const DECREASE_POSITION_WITH_TPSL_DISCRIMINATOR = new Uint8Array([
  108, 18, 203, 209, 227, 103, 65, 165,
])

export function getDecreasePositionWithTpslDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DECREASE_POSITION_WITH_TPSL_DISCRIMINATOR,
  )
}
...
export type DecreasePositionWithTpslInstructionData = {
  discriminator: ReadonlyUint8Array
}

export type DecreasePositionWithTpslInstructionDataArgs = {}

export function getDecreasePositionWithTpslInstructionDataEncoder(): FixedSizeEncoder<DecreasePositionWithTpslInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: DECREASE_POSITION_WITH_TPSL_DISCRIMINATOR,
    }),
  )
}

export function getDecreasePositionWithTpslInstructionDataDecoder(): FixedSizeDecoder<DecreasePositionWithTpslInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ])
}

export function getDecreasePositionWithTpslInstructionDataCodec(): FixedSizeCodec<
  DecreasePositionWithTpslInstructionDataArgs,
  DecreasePositionWithTpslInstructionData
> {
  return combineCodec(
    getDecreasePositionWithTpslInstructionDataEncoder(),
    getDecreasePositionWithTpslInstructionDataDecoder(),
  )
}

export type DecreasePositionWithTpslInput<
...
export function getDecreasePositionWithTpslInstruction<
  TAccountKeeper extends string,
  TAccountOwner extends string,
  TAccountTransferAuthority extends string,
  TAccountPerpetuals extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getDecreasePositionWithTpslInstructionDataEncoder().encode({}),
    programAddress,
  } as DecreasePositionWithTpslInstruction<
    TProgramAddress,
    TAccountKeeper,
    TAccountOwner,
    TAccountTransferAuthority,
...
> = {
  ...
  data: DecreasePositionWithTpslInstructionData
}
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedDecreasePositionWithTpslInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDecreasePositionWithTpslInstructionDataDecoder().decode(
      instruction.data,
    ),
  }
}
