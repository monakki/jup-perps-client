...
> = {
  ...
  maxTriggerPriceDiffBps: OperatorSetPoolConfigInstructionDataArgs['maxTriggerPriceDiffBps']
  disableClosePositionRequest: OperatorSetPoolConfigInstructionDataArgs['disableClosePositionRequest']
  maxLpTokenPriceChangeBps: OperatorSetPoolConfigInstructionDataArgs['maxLpTokenPriceChangeBps']
}
...
>(
  ...
  return {
    ...
    accounts: { operator: getNextAccount(), pool: getNextAccount() },
