...
export const SWAP_WITH_TOKEN_LEDGER_DISCRIMINATOR = new Uint8Array([
  139, 141, 238, 197, 41, 211, 172, 19,
])

export function getSwapWithTokenLedgerDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    SWAP_WITH_TOKEN_LEDGER_DISCRIMINATOR,
  )
}
...
export type SwapWithTokenLedgerInstructionData = {
  discriminator: ReadonlyUint8Array
  minAmountOut: bigint
}

export type SwapWithTokenLedgerInstructionDataArgs = {
  minAmountOut: number | bigint
}

export function getSwapWithTokenLedgerInstructionDataEncoder(): FixedSizeEncoder<SwapWithTokenLedgerInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: SWAP_WITH_TOKEN_LEDGER_DISCRIMINATOR,
    }),
  )
}

export function getSwapWithTokenLedgerInstructionDataDecoder(): FixedSizeDecoder<SwapWithTokenLedgerInstructionData> {
...
export function getSwapWithTokenLedgerInstructionDataCodec(): FixedSizeCodec<
  SwapWithTokenLedgerInstructionDataArgs,
  SwapWithTokenLedgerInstructionData
> {
  return combineCodec(
    getSwapWithTokenLedgerInstructionDataEncoder(),
    getSwapWithTokenLedgerInstructionDataDecoder(),
  )
}

export type SwapWithTokenLedgerInput<
...
> = {
  ...
  minAmountOut: SwapWithTokenLedgerInstructionDataArgs['minAmountOut']
}

export function getSwapWithTokenLedgerInstruction<
  TAccountOwner extends string,
  TAccountFundingAccount extends string,
  TAccountReceivingAccount extends string,
  TAccountTransferAuthority extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getSwapWithTokenLedgerInstructionDataEncoder().encode(
      args as SwapWithTokenLedgerInstructionDataArgs,
    ),
    programAddress,
  } as SwapWithTokenLedgerInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountFundingAccount,
    TAccountReceivingAccount,
...
> = {
  ...
  accounts: {
    ...
    tokenLedger: TAccountMetas[12]
    tokenProgram: TAccountMetas[13]
    instruction: TAccountMetas[14]
    eventAuthority: TAccountMetas[15]
    program: TAccountMetas[16]
  }
  data: SwapWithTokenLedgerInstructionData
}
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedSwapWithTokenLedgerInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getSwapWithTokenLedgerInstructionDataDecoder().decode(
      instruction.data,
    ),
  }
}
