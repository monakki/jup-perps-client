...
export const CLOSE_POSITION_REQUEST2_DISCRIMINATOR = new Uint8Array([
  121, 68, 162, 28, 216, 47, 200, 66,
])

export function getClosePositionRequest2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_POSITION_REQUEST2_DISCRIMINATOR,
  )
}

export type ClosePositionRequest2Instruction<
...
export type ClosePositionRequest2InstructionData = {
  discriminator: ReadonlyUint8Array
}

export type ClosePositionRequest2InstructionDataArgs = {}

export function getClosePositionRequest2InstructionDataEncoder(): FixedSizeEncoder<ClosePositionRequest2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: CLOSE_POSITION_REQUEST2_DISCRIMINATOR,
    }),
  )
}

export function getClosePositionRequest2InstructionDataDecoder(): FixedSizeDecoder<ClosePositionRequest2InstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ])
}

export function getClosePositionRequest2InstructionDataCodec(): FixedSizeCodec<
  ClosePositionRequest2InstructionDataArgs,
  ClosePositionRequest2InstructionData
> {
  return combineCodec(
    getClosePositionRequest2InstructionDataEncoder(),
    getClosePositionRequest2InstructionDataDecoder(),
  )
}

export type ClosePositionRequest2Input<
...
export function getClosePositionRequest2Instruction<
  TAccountKeeper extends string,
  TAccountOwner extends string,
  TAccountOwnerAta extends string,
  TAccountPool extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getClosePositionRequest2InstructionDataEncoder().encode({}),
    programAddress,
  } as ClosePositionRequest2Instruction<
    TProgramAddress,
    TAccountKeeper,
    TAccountOwner,
    TAccountOwnerAta,
...
export type ParsedClosePositionRequest2Instruction<
  TProgram extends string = typeof PERPETUALS_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClosePositionRequest2InstructionData
}

export function parseClosePositionRequest2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedClosePositionRequest2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClosePositionRequest2InstructionDataDecoder().decode(
      instruction.data,
    ),
  }
}
