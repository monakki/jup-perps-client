...
export const PERPETUALS_ERROR__INVALID_ORACLE_SIGNER = 0x17a8 // 6056
/** InvalidOracleTimestamp: Invalid Oracle Timestamp */
export const PERPETUALS_ERROR__INVALID_ORACLE_TIMESTAMP = 0x17a9 // 6057
/** InvalidMaxGlobalLongSize: New Max Global Long Size Too Low */
export const PERPETUALS_ERROR__INVALID_MAX_GLOBAL_LONG_SIZE = 0x17aa // 6058
/** InvalidMaxGlobalShortSize: New Max Global Short Size Too Low */
export const PERPETUALS_ERROR__INVALID_MAX_GLOBAL_SHORT_SIZE = 0x17ab // 6059
/** BorrowsDisabled: Borrows disabled for this custody */
export const PERPETUALS_ERROR__BORROWS_DISABLED = 0x17ac // 6060
/** BorrowLimitsExceeded: Borrows limit exceeded for this custody */
export const PERPETUALS_ERROR__BORROW_LIMITS_EXCEEDED = 0x17ad // 6061
/** WithdrawExceedsMarginLimits: Withdraw exceeds margin of the custody */
export const PERPETUALS_ERROR__WITHDRAW_EXCEEDS_MARGIN_LIMITS = 0x17ae // 6062
/** CannotLiquidate: Cannot liquidate */
export const PERPETUALS_ERROR__CANNOT_LIQUIDATE = 0x17af // 6063
/** CannotDelegateStake: Cannot delegate stake to deactivated account */
export const PERPETUALS_ERROR__CANNOT_DELEGATE_STAKE = 0x17b0 // 6064
/** ExceededMaxTotalStakedAmount: Max total staked amount exceeded */
export const PERPETUALS_ERROR__EXCEEDED_MAX_TOTAL_STAKED_AMOUNT = 0x17b1 // 6065
/** LpTokenPriceChangeLimitExceeded: LP token price change exceeds limit */
export const PERPETUALS_ERROR__LP_TOKEN_PRICE_CHANGE_LIMIT_EXCEEDED = 0x17b2 // 6066

export type PerpetualsError =
  | typeof PERPETUALS_ERROR__ADDRESS_MISMATCH
  | typeof PERPETUALS_ERROR__BORROW_LIMITS_EXCEEDED
  | typeof PERPETUALS_ERROR__BORROWS_DISABLED
  | typeof PERPETUALS_ERROR__CANNOT_DELEGATE_STAKE
  | typeof PERPETUALS_ERROR__CANNOT_LIQUIDATE
  ...
  | typeof PERPETUALS_ERROR__EXCEEDED_MAX_TOTAL_STAKED_AMOUNT
  ...
  | typeof PERPETUALS_ERROR__INVALID_MAX_GLOBAL_LONG_SIZE
  | typeof PERPETUALS_ERROR__INVALID_MAX_GLOBAL_SHORT_SIZE
  ...
  | typeof PERPETUALS_ERROR__INVALID_ORACLE_SIGNER
  | typeof PERPETUALS_ERROR__INVALID_ORACLE_TIMESTAMP
  ...
  | typeof PERPETUALS_ERROR__LP_TOKEN_PRICE_CHANGE_LIMIT_EXCEEDED
  ...
  | typeof PERPETUALS_ERROR__WITHDRAW_EXCEEDS_MARGIN_LIMITS
...
if (process.env.NODE_ENV !== 'production') {
  perpetualsErrorMessages = {
    ...
    [PERPETUALS_ERROR__BORROW_LIMITS_EXCEEDED]: `Borrows limit exceeded for this custody`,
    [PERPETUALS_ERROR__BORROWS_DISABLED]: `Borrows disabled for this custody`,
    [PERPETUALS_ERROR__CANNOT_DELEGATE_STAKE]: `Cannot delegate stake to deactivated account`,
    [PERPETUALS_ERROR__CANNOT_LIQUIDATE]: `Cannot liquidate`,
    ...
    [PERPETUALS_ERROR__EXCEEDED_MAX_TOTAL_STAKED_AMOUNT]: `Max total staked amount exceeded`,
    ...
    [PERPETUALS_ERROR__INVALID_MAX_GLOBAL_LONG_SIZE]: `New Max Global Long Size Too Low`,
    [PERPETUALS_ERROR__INVALID_MAX_GLOBAL_SHORT_SIZE]: `New Max Global Short Size Too Low`,
    ...
    [PERPETUALS_ERROR__INVALID_ORACLE_SIGNER]: `Invalid Oracle Signer`,
    [PERPETUALS_ERROR__INVALID_ORACLE_TIMESTAMP]: `Invalid Oracle Timestamp`,
    ...
    [PERPETUALS_ERROR__LP_TOKEN_PRICE_CHANGE_LIMIT_EXCEEDED]: `LP token price change exceeds limit`,
    ...
    [PERPETUALS_ERROR__WITHDRAW_EXCEEDS_MARGIN_LIMITS]: `Withdraw exceeds margin of the custody`,
  }
}
